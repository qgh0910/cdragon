...
- `text-embedding-v4` - **推荐**，1024 维，高质量中文嵌入
...
print(f"主对话模型: {settings.dashscope_model}")
...
print(f"重排序 API: {settings.cloud_reranker_base_url or settings.dashscope_base_url}")
